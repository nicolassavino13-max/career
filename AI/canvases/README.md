...
| Applications tracker | `AI/canvases/applications-tracker.canvas.tsx` | `Career/applications_tracker.md` | PROMOTE save, or `node AI/.cursor/hooks/sync_pipeline_canvas.mjs --force` |
